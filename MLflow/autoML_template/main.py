...
def main():
    ...
    mlflow_manager.set_log_params_metrics(base_metrics_params)
    ...
    mlflow_manager.save_model_artifacts(model_trainer.model, model_instance, model_name)
    mlflow_manager.save_model_artifacts(model_trainer.baseline_model, base_model_instance, base_model_name)
